...
@push('styles')
    <style>
        ...
        @media (max-width: 991.98px) {
            ...
            /* Game Manage Tab Responsive */
            #game-content .tool-tab {
                font-size: 0.85rem;
                padding: 0.6rem 0.5rem;
            }

            /* Donate Benefits Responsive */
            #donate-benefits-content>div {
                flex-direction: column !important;
                gap: 1rem !important;
            }

            #donate-benefits-content>div>div:first-child {
                grid-template-columns: 1fr !important;
                gap: 1rem !important;
            }

            #donate-benefits-content button {
                width: 100%;
            }
        }
        ...
        @media (max-width: 767.98px) {
            ...
            /* Donate Benefits */
            #donate-benefits-content h6 {
                font-size: 0.85rem;
            }

            #donate-benefits-content p {
                font-size: 0.8rem;
            }
        ...
        @media (max-width: 575.98px) {
            ...
            /* Game Content Tools Tabs */
            #game-content>div:nth-child(2) {
                flex-wrap: wrap;
            }
        ...
        /* Horizontal Scroll for Menu on Small Devices */
        @media (max-width: 767.98px) {
                    ...
                    <div class="tool-content" id="donate-benefits-content" style="display: none;">
                        ...
                        <div
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; flex: 1;">
                                <div>
                                    <h6 style="color: #f59e0b; font-weight: 700; font-size: 0.95rem; margin-bottom: 1rem;">
                                        Total Donate</h6>
                                    <p style="color: #00bcd4; font-size: 1.1rem; font-weight: 700; margin-bottom: 0.5rem;">
                                        IDR 500.000</p>
