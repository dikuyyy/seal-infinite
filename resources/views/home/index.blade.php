...
@push('styles')
    <style>
        ...
        .hero-2 {
            ...
            min-height: 100vh;
            color: #eef3ff;
            background: url("{{ asset('images/background/hero-2.png') }}") center/cover no-repeat;
        }
        ...
        .hero-2::before {
            ...
            right: 0;
            height: 150px;
            background: radial-gradient(1200px 600px at 75% 40%, rgba(36, 79, 170, .35), transparent 60%),
        ...
        .hero-3 {
            ...
            min-height: 65vh;
            color: #eef3ff;
            background: url("{{ asset('images/background/hero-3.png') }}") center/cover no-repeat;
            display: flex;
            align-items: center;
        }
        ...
        .hero-3::before {
            ...
            right: 0;
            height: 150px;
            background: radial-gradient(1400px 700px at 50% 50%, rgba(74, 20, 140, .25), transparent 70%),
                linear-gradient(to bottom, #000, transparent);
            pointer-events: none;
        }
        ...
        .hero-4 {
            position: relative;
            min-height: 100vh;
            background: url("{{ asset('images/background/hero-4.jpg') }}") center/cover no-repeat;
            display: flex;
            align-items: center;
        }
        ...
        .achievement-card:hover {
            ...
            box-shadow: 0 30px 80px rgba(74, 20, 140, .5),
        ...
        /* Responsive for Achievement Cards */
        ...
        .stat-item:hover .stat-icon {
            filter: drop-shadow(0 12px 24px rgba(74, 20, 140, .5));
        ...
        .display-hero strong {
            color: #ffffff;
            text-shadow: 0 4px 28px rgba(41, 95, 255, .5);
        }
        ...
        .cta-btn {
            ...
            box-shadow: 0 10px 30px rgba(74, 20, 140, .4),
        ...
        .cta-btn:hover {
            ...
            box-shadow: 0 15px 40px rgba(74, 20, 140, .5),
        ...
        .event-card .bg-img {
            background: url("{{ asset('images/event-1.png') }}") center/cover no-repeat;
            opacity: .85;
            position: absolute;
            inset: 0;
            z-index: 0;
        ...
        .event-card::after {
            ...
            inset: 0;
            z-index: 1;
            background: linear-gradient(180deg, rgba(5, 8, 18, .0) 20%, rgba(5, 8, 18, .75) 100%);
        }
        ...
        .calendar-container {
            position: relative;
            z-index: 2;
            background: linear-gradient(145deg, rgba(13, 71, 161, 0.25), rgba(74, 20, 140, 0.25));
            backdrop-filter: blur(16px);
        ...
        .calendar-day.has-event {
            background: linear-gradient(135deg, rgba(74, 20, 140, 0.4), rgba(13, 71, 161, 0.4));
        ...
        .discord-card {
            position: relative;
            z-index: 2;
            background: linear-gradient(145deg, rgba(88, 101, 242, 0.25), rgba(114, 137, 218, 0.25));
            backdrop-filter: blur(16px);
        ...
        .discord-card:hover .discord-logo-wrapper {
            transform: scale(1.1) rotate(5deg);
            box-shadow:
                0 25px 50px rgba(88, 101, 242, 0.6),
...
@section('content')
    <section class="hero">
        <div class="container hero-content" style="padding-top:12rem">
            <div class="row">
                <div class="col-lg-7 col-xl-6">
                    <h1 class="display-hero fw-bold mb-3">
                        The <strong>Battle</strong> Awakens
                    </h1>
                    <p class="lead mb-4">
                        Pertempuran Baru Telah Dimulai! Kumpulkan timmu dan hadapi Boss
                        Terseram di Dunia Shiltz!
                    </p>
                    <a href="#" class="cta-btn d-inline-flex align-items-center gap-2">
                        Main Sekarang <i class="bi bi-arrow-right-short fs-4"></i>
                    </a>
                </div>
            </div>
        </div>

        <section style="margin-top: 16.5rem; padding-bottom: 6rem;">
            <div class="container">
                <h2 class="fw-bold mb-4" style="color: white!important">EVENT</h2>

                <div class="row g-4">
                    <!-- Kartu besar kiri -->
                    <div class="col-lg-7">
                        <div class="event-card event-left">
                            <div class="bg-img"></div>
                            <div class="event-body d-flex flex-column h-100 justify-content-end">
                                <div class="event-title mb-1">Guild War Hall Season 2</div>

                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <div class="event-meta mb-3">Minimal Level 271</div>
                                    </div>
                                    <div class="d-flex">
                    ...
                    <!-- Dua kartu kanan bertumpuk -->
                    <div class="col-lg-5 d-flex flex-column gap-4">
                        <div class="event-card event-right">
                            <div class="bg-img"></div>
                            <div class="event-body d-flex flex-column h-100 justify-content-end">
                                <div>
                                    <div class="event-title mb-1">PVP 5 VS 5 Championship</div>
                                    <div class="event-meta mb-3">Minimal Level 271</div>
                                </div>
                                <div class="d-flex">
                                    <a href="#" class="event-view ms-auto">View Detail <i
    ...
    <section class="hero-2">
        <div class="d-flex justify-content-center flex-column align-items-center hero-content" style="padding-top: 6rem">
            <h1>LIBRARY OF SHILTZ</h1>
            <div style="font-size: 1.2rem">Book Of Knowledge</div>
            <div class="d-flex justify-content-center gap-4 mt-4">
                <a href="#" class="library-card">
                    <img src="{{ asset('images/card-1.png') }}" alt="card-1" />
                    <div class="text-center library-card-title">Item Database</div>
                </a>
                <a href="#" class="library-card">
                    <img src="{{ asset('images/card-2.png') }}" alt="card-2" />
                    <div class="text-center library-card-title">Monster Drop Database</div>
                </a>
                <a href="#" class="library-card">
                    <img src="{{ asset('images/card-3.png') }}" alt="card-3" />
                    <div class="text-center library-card-title">Fishing Database</div>
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="hero-3">
        <div class="container hero-3-content">
            <div class="stats-glass">
                <div class="stats-wrapper">
                    <!-- Kiri -->
                    <div class="stat-item">
                        <img class="stat-icon" src="{{ asset('images/coin.png') }}" alt="coin">
                        <div>
                            <div class="stat-value">100,283,276,780</div>
                            <div class="stat-title">Total <strong>Cegel</strong></div>
                        </div>
                    </div>
                    ...
                    <div class="stat-item right">
                        <img class="stat-icon" src="{{ asset('images/player.png') }}" alt="player">
                        <div>
                            <div class="stat-value">100,283,276,780</div>
                            <div class="stat-title">Total <strong>Player</strong></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="hero-4">
        <div class="container hero-4-content">
            <div class="row justify-content-center align-items-center g-5">
                <!-- Best Guild Card -->
                <div class="col-lg-5 col-md-6">
                    <div class="achievement-card">
                        <h2 class="achievement-title">Best Guild</h2>
                        <div class="achievement-icon-wrapper">
                            <img src="{{ asset('images/best-guild-icon.png') }}" alt="Best Guild"
                                class="achievement-icon">
                        </div>
                        <div class="achievement-name">Everyone</div>
                        <div class="achievement-stats">7 Point</div>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="achievement-card">
                        <h2 class="achievement-title">Best Player</h2>
                        <div class="achievement-icon-wrapper">
                            <img src="{{ asset('images/best-player-icon.png') }}" alt="Best Player"
                                class="achievement-icon">
                        </div>
                        <div class="achievement-name">X</div>
                        <div class="achievement-stats">141 Kill Point</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="calendar-discord-section">
        <div class="container">
            <div class="row g-5">
                <!-- Calendar -->
                <div class="col-lg-7">
                    <div class="calendar-container">
                        ...
                        <div class="calendar-days">
                            ...
                            <div class="calendar-day has-event">
                                ...
                                <div class="calendar-event-indicator">Guild War</div>
                            </div>
                            <div class="calendar-day">
                            ...
                            <div class="calendar-day has-event today">
                                <div class="calendar-day-number">10</div>
                                <div class="calendar-event-indicator">PVP 5v5</div>
                            </div>
                            <div class="calendar-day">
                            ...
                            <div class="calendar-day has-event">
                                ...
                                <div class="calendar-event-indicator">Boss Raid</div>
                            </div>
                            <div class="calendar-day">
                            ...
                            <div class="calendar-day has-event">
                                ...
                                <div class="calendar-event-indicator">Tournament</div>
                            </div>
                            <div class="calendar-day">
                            ...
                            <div class="calendar-day has-event">
                                ...
                                <div class="calendar-event-indicator">Xmas Event</div>
                            </div>
                            <div class="calendar-day has-event">
                                <div class="calendar-day-number">25</div>
                                <div class="calendar-event-indicator">Xmas Event</div>
                            ...
                            <div class="calendar-day has-event">
                                ...
                                <div class="calendar-event-indicator">New Year</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="discord-card">
                        ...
                        <h2 class="discord-title">Join Our Discord</h2>
                        <p class="discord-description">
                            Bergabunglah dengan komunitas Seal Infinite! Dapatkan info event terbaru, tips & trik, dan
                            bertemu dengan pemain lain.
                        </p>
                        <a href="#" class="discord-join-btn">
                            <i class="bi bi-discord fs-4"></i>
                            Join Discord Server
                        </a>
                        <div class="discord-stats">
                            <div class="discord-stat-item">
                                <span class="discord-stat-value">15,847</span>
                                <span class="discord-stat-label">Members</span>
                            </div>
                            <div class="discord-stat-item">
                                <span class="discord-stat-value">3,241</span>
